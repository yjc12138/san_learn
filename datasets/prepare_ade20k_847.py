...
if __name__ == "__main__":
    ...
    with open(index_file, "rb") as f:#"r" 表示读取（read）
        #"b" 表示二进制模式（binary）
        index_ade20k = pkl.load(f)#加载pickle文件
    ...
    for name in ["training", "validation"]:
        ...
        image_dir.mkdir(parents=True, exist_ok=True)# parents=True 会创建所有必要的父目录  exist_ok=True 目录已存在，但不会报错
